...
function Sidebar() {
  const items = [
    ...
    { id: 'stu',  label: 'My Students',            icon: IconUsers },
  ...
  return (
    <div className="combo" ref={wrapRef}>
      {open ? (
        ...
        <div className={`selectish ${open ? 'focus' : ''}`} onClick={() => setOpen(true)}>
          {selected ? (
            ...
            <span className="placeholder">Select student</span>
          )}
...
function Step1({ data, set, onNext }) {
  const valid = data.student && data.date && data.duration;
  return (
    <>
      <div className="card">
        ...
        <div className="form-grid">
          <div className="field col-2">
            ...
            <StudentSelect value={data.student} onChange={(v) => set('student', v)} />
          </div>
