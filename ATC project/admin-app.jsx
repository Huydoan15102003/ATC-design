                ...
                <td onClick={(e) => e.stopPropagation()}>
                  <RowMenu
                    ...
                    items={[
                      ...
                      { label: 'Reassign teacher', action: 'reassign', icon: <IconUsers size={14} /> },
                      { sep: true },
...
function TeacherDrawer({ teacher, drawerTab, setDrawerTab, onClose }) {
  const assignedStudents = STUDENTS.filter((s) => s.teacher === teacher.id);
